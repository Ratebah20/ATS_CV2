...
def apply(job_id):
    ...
    if form.validate_on_submit():
        ...
        if cv_file:
            ...
            return redirect(url_for('application.confirmation'))
    
    return render_template('public/application/apply.html', job=job, form=form, year=datetime.now().year)
...
def confirmation():
    ...
    return render_template('public/application/confirmation.html', application=application, job=job, year=datetime.now().year)
